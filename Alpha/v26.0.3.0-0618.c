...
#define GAME_VER "v26.0.3.0-0618"
...
// 손님들
/** @brief 손님1의 데이터 */
Customer C1 = {.ID = NOMAL, .Probability = 100, .Message = "안녕하세요! 빵 하나 주실래요?", .Item = {.Answer1 = "준다", .Answer2 = "안 준다", 1}, .IF_Money = 10, .IF_Repute = 1, .ELSE_Money = 0, .ELSE_Repute = 2};
